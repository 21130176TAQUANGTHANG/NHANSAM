...
<div class="tab_content">
    ...
    <div class="product-container" id="menu_2">
        <div class="product-ite">
            ...
            <a href=""><p>Nấm Đông Trùng Hạ Thảo Hàn Quốc 100G Sấy khô </p></a>
            <div class="buy">
                <p>2,000,000</p>
                <button type="button" class="btn-ginseng">Mua</button>
            </div>
        ...
        <div class="product-ite">
            ...
            <a href=""><p>Nước Đông Trùng Hạ Thảo Hàn Quốc Hộp Gỗ 60 Gói</p></a>
            <div class="buy">
                <p>1,750,000</p>
                <button type="button" class="btn-ginseng">Mua</button>
            </div>
        ...
        <div class="product-ite">
            ...
            <a href=""><p>Viên Đạm Sâm Nhung Linh Chi Đông Trùng Hạ Thảo Hàn Quốc</p></a>
            <div class="buy">
                <p>1,100,000</p>
                <button type="button" class="btn-ginseng">Mua</button>
            </div>
        ...
        <div class="product-ite">
            ...
            <a href=""><p>Cao Linh Chi Đông Trùng Hạ Thảo Hàn Quốc</p></a>
            <div class="buy">
                <p>850,000</p>
                <button type="button" class="btn-ginseng">Mua</button>
            </div>
        ...
        <div class="product-ite">
            ...
            <a href=""><p>Chất Chiết Đông Trùng Hạ Thảo Hộp 20 Ống Bio-science</p></a>
            <div class="buy">
                <p>1,200,000</p>
                <button type="button" class="btn-ginseng">Mua</button>
            </div>
        ...
        <div class="product-ite">
            ...
            <a href=""><p>Đông Trùng Hạ Thảo nguyên con loại 1 hộp gỗ 10g</p></a>
            <div class="buy">
                <p>11,000,000</p>
                <button type="button" class="btn-ginseng">Mua</button>
            </div>
    ...
    <div class="product-container" id="menu_3">
        <div class="product-ite">
            ...
            <a href=""><p>Hồng Sâm Tẩm Mật Ong Hàn Quốc 6 Năm Tuổi ACHIMMADANG 300G </p></a>
            <div class="buy">
                <p>1,100,000</p>
                <button type="button" class="btn-ginseng">Mua</button>
            </div>
        ...
        <div class="product-ite">
            ...
            <a href=""><p>Nước Hồng Sâm Linh Chi Táo Đỏ Hàn Quốc Hộp 30 Gói x 80ml</p></a>
            <div class="buy">
                <p>750,000</p>
                <button type="button" class="btn-ginseng">Mua</button>
            </div>
        ...
        <div class="product-ite">
            ...
            <a href=""><p>Hắc Sâm Củ Khô Daedong Hàn Quốc 300G Hộp Thiếc</p></a>
            <div class="buy">
                <p>7,200,000</p>
                <button type="button" class="btn-ginseng">Mua</button>
            </div>
        ...
        <div class="product-ite">
            ...
            <a href=""><p>Nước Hồng Sâm Tăng Lực Vital Tonic KGC Hộp 10 Ống</p></a>
            <div class="buy">
                <p>940,000</p>
                <button type="button" class="btn-ginseng">Mua</button>
            </div>
        ...
        <div class="product-ite">
            ...
            <a href=""><p>Viên Cao Hồng Sâm KGC Cheong Kwan Jang Hàn Quốc Hộp 2 Lọ x 168G</p></a>
            <div class="buy">
                <p>2,700,000</p>
                <button type="button" class="btn-ginseng">Mua</button>
            </div>
        ...
        <div class="product-ite">
            ...
            <a href=""><p>Trà Hồng Sâm Buleebang Hàn Quốc 3g x 100 Gói</p></a>
            <div class="buy">
                <p>340,000</p>
                <button type="button" class="btn-ginseng">Mua</button>
            </div>
    ...
    <div class="product-container" id="menu_4">
        <div class="product-ite">
            ...
            <a href=""><p>Nấm Linh Chi Thượng Hoàng Hàn Quốc Cao Cấp Gói 1 Kg </p></a>
            <div class="buy">
                <p>3,800,000</p>
                <button type="button" class="btn-ginseng">Mua</button>
            </div>
        ...
        <div class="product-ite">
            ...
            <a href=""><p>Nấm Linh Chi Fuji Đỏ Nguyên Tai Nhật Bản Gói 500G </p></a>
            <div class="buy">
                <p>1,249,000</p>
                <button type="button" class="btn-ginseng">Mua</button>
            </div>
        ...
        <div class="product-ite">
            <img src="https://samyenanhquan.com/wp-content/uploads/2020/11/caohshopgo2lo1.jpg" alt="Mô tả hình ảnh" width="200" height="190">
            <a href=""><p>Cao Hồng Sâm Linh Chi ACHIMMADANG Hộp Gỗ 2 Hủ x 500G</p></a>
            <div class="buy">
                <p>2,100,000</p>
                <button type="button" class="btn-ginseng">Mua</button>
            </div>
        ...
        <div class="product-ite">
            ...
            <a href=""><p>Nấm Linh Chi Núi Đá Vàng Hàn Quốc Túi 1 Kg</p></a>
            <div class="buy">
                <p>2,300,000</p>
                <button type="button" class="btn-ginseng">Mua</button>
            </div>
        ...
        <div class="product-ite">
            ...
            <a href=""><p>Nấm Linh Chi Đỏ Hàn Quốc Loại 1 Cắt Lát Sẵn 1KG</p></a>
            <div class="buy">
                <p>3,000,000</p>
                <button type="button" class="btn-ginseng">Mua</button>
            </div>
        ...
        <div class="product-ite">
            ...
            <a href=""><p>Nấm Linh Chi Đỏ Việt Nam Hoàng Gia 500G Nguyên Tai</p></a>
            <div class="buy">
                <p>450,000</p>
                <button type="button" class="btn-ginseng">Mua</button>
            </div>
    ...
    <div class="product-container" id="menu_5">
        <div class="product-ite">
            ...
            <a href=""><p>Yến Thô Còn Lông Ngọc Hoàng Yến Hộp 100g (12-14 Tổ) </p></a>
            <div class="buy">
                <p>2,900,000</p>
                <button type="button" class="btn-ginseng">Mua</button>
            </div>
        ...
        <div class="product-ite">
            ...
            <a href=""><p>Yến Rút Lông Ngọc Hoàng Yến Hộp 100g (13-14 Tổ) </p></a>
            <div class="buy">
                <p>4,200,000</p>
                <button type="button" class="btn-ginseng">Mua</button>
            </div>
        ...
        <div class="product-ite">
            ...
            <a href=""><p>Yến Tươi Rút Lông Ngọc Hoàng Yến Hộp 5 Túi 100g </p></a>
            <div class="buy">
                <p>700,000</p>
                <button type="button" class="btn-ginseng">Mua</button>
            </div>
        ...
        <div class="product-ite">
            ...
            <a href=""><p>Yến Chưng Hồng Cúc Hoa Mật Ong - Hũ 100ml </p></a>
            <div class="buy">
                <p>110,000</p>
                <button type="button" class="btn-ginseng">Mua</button>
            </div>
        ...
        <div class="product-ite">
            ...
            <a href=""><p>Yến Chưng Hồng Hoa Đường Stevia - Hũ 200ml </p></a>
            <div class="buy">
                <p>200,000</p>
                <button type="button" class="btn-ginseng">Mua</button>
            </div>
        ...
        <div class="product-ite">
            ...
            <a href=""><p>Yến Chưng Hồng Hoa Cúc Táo Đỏ Đường Stevia- Hũ 100ml </p></a>
            <div class="buy">
                <p>110,000</p>
                <button type="button" class="btn-ginseng">Mua</button>
            </div>
    ...
    <div class="product-container" id="menu_6">
        <div class="product-ite">
            ...
            <a href=""><p>An Cung Ngưu Hoàn Bio Apgold Hộp 10 Viên - Woohwang Cheongsimwon </p></a>
            <div class="buy">
                <p>1,850,000</p>
                <button type="button" class="btn-ginseng">Mua</button>
            </div>
        ...
        <div class="product-ite">
            ...
            <a href=""><p>An Cung Ngưu Hàn Quốc Vũ Hoàng Thanh Tâm</p></a>
            <div class="buy">
                <p>1,900,000</p>
                <button type="button" class="btn-ginseng">Mua</button>
            </div>
        ...
        <div class="product-ite">
            ...
            <a href=""><p>An Cung Ngưu Hàn Quốc Vũ Hoàng Thanh Tâm Hộp Gỗ 10 Viên</p></a>
            <div class="buy">
                <p>2,500,000</p>
                <button type="button" class="btn-ginseng">Mua</button>
            </div>
        ...
        <div class="product-ite">
            ...
            <a href=""><p>An Cung Ngưu Hoàng Hoàn Hàn Quốc Tuần Hoàn Não Hộp Gỗ 60 Viên</p></a>
            <div class="buy">
                <p>1,500,000</p>
                <button type="button" class="btn-ginseng">Mua</button>
            </div>
    ...
    <div class="product-container" id="menu_7">
        <div class="product-ite">
            ...
            <a href=""><p>Nước Uống Thanh Nhiệt Bổ Gan Tiêu Độc Hàn Quốc 1 Chai </p></a>
            <div class="buy">
                <p>550,000</p>
                <button type="button" class="btn-ginseng">Mua</button>
            </div>
        ...
        <div class="product-ite">
            ...
            <a href=""><p>Thực Phẩm Chức Năng Nước Uống Bổ Gan Hepalyse II Nhật Bản 10 Chai x 50ml  </p></a>
            <div class="buy">
                <p>600,000</p>
                <button type="button" class="btn-ginseng">Mua</button>
            </div>
        ...
        <div class="product-ite">
            ...
            <a href=""><p>Nước Uống Bổ Gan Hovenia Dulcis Thunberg Hộp 30 Gói </p></a>
            <div class="buy">
                <p>650,000</p>
                <button type="button" class="btn-ginseng">Mua</button>
            </div>
        ...
        <div class="product-ite">
            ...
            <a href=""><p>Nước Uống Tinh Chất Nghệ Bổ Gan Matsukiyo Turmeric (Lốc 6 Chai x 100ml) </p></a>
            <div class="buy">
                <p>490,000</p>
                <button type="button" class="btn-ginseng">Mua</button>
            </div>
