...
<body>
<header id="header" style="background-color: #BF1E2E;">
    <div class="header-menu">
        ...
        <div class="menu">
            <ul class="nav nav-pills">
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="index.jsp" style="color: #dddddd;">TRANG CHỦ</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="Productss.jsp"style="color: #dddddd;">SẢN PHẨM</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="cart.jsp"style="color: #dddddd;">CART </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#"style="color: #dddddd;">HỆ THỐNG</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#"style="color: #dddddd;">LIÊN HỆ</a>
                </li>
            </ul>
        </div>
    ...
    background-color: snow;"><i class="bi bi-search"></i></button>
        ...
        <div class="account">
            <div class="sign-in">
                ...
                <% if(auth == null){ %>
                <a href="sign-up.jsp" style="color: #dddd;
    text-decoration: none;
    font-size: 20px;">Đăng ký</a>
                <a href="login.jsp" style="color: #dddd;
    text-decoration: none;
...
<div class="product-sell">
    ...
    <div class="product-containers" style="display: flex;
