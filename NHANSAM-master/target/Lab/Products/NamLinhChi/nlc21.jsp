...
<div id="super-item">
    ...
    <div class="img-product">
        <div class="img">
            <img src="https://linhchinonglam.com/wp-content/uploads/2018/12/nam-linh-linh-chi-nong-lam-cao-cap-bot-01.jpg" alt="">
        </div>

        <div class="information-product">
            <div class="information-buy">

                <h2>Linh Chi Nông Lâm Cao Cấp Dạng Bột (250g)</h2>
                ...
                <div class="buy-item">
                    <%
                        ...
                        Product product = db.getById(53);
                    %>
                    <a href="#"><i class="bi bi-cart"></i>add cart</a>
                    <a href="../../add-cart?id=<%= product.getId(53)%>">Thêm vào giỏ hàng</a>
                </div>
            </div>
