...
<div id="super-item">
    ...
    <div class="img-product">
        <div class="img">
            <img src="https://linhchinonglam.com/wp-content/uploads/2018/11/DongTrungHaThaoNongLam01.png" alt="">
        </div>

        <div class="information-product">
            <div class="information-buy">

                <h2>Đông Trùng Hạ Thảo Nông Lâm (100g)</h2>
                ...
                <div class="buy-item">
                    <%
                        ...
                        Product product = db.getById(56);
                    %>
                    <a href="#"><i class="bi bi-cart"></i>add cart</a>
                    <a href="../../add-cart?id=<%= product.getId(56)%>">Thêm vào giỏ hàng</a>
                </div>
            </div>
