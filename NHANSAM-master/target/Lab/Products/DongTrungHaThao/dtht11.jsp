...
<div id="super-item">
    ...
    <div class="img-product">
        <div class="img">
            <img src="https://linhchinonglam.com/wp-content/uploads/2019/06/2-3.jpg" alt="">
        </div>

        <div class="information-product">
            <div class="information-buy">

                <h2>Trùng Thảo Mật Ong Nông Lâm 500ml</h2>
                ...
                <div class="buy-item">
                    <%
                        ...
                        Product product = db.getById(58);
                    %>
                    <a href="#"><i class="bi bi-cart"></i>add cart</a>
                    <a href="../../add-cart?id=<%= product.getId(58)%>">Thêm vào giỏ hàng</a>
                </div>
            </div>
