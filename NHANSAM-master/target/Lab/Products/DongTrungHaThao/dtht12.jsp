...
<div id="super-item">
    ...
    <div class="img-product">
        <div class="img">
            <img src="https://linhchinonglam.com/wp-content/uploads/2018/11/dong-trung-ha-thao-4.jpeg" alt="">
        </div>

        <div class="information-product">
            <div class="information-buy">

                <h2>Viên Nang Đông Trùng Hạ Thảo Nông Lâm 10 Lọ</h2>
                ...
                <div class="buy-item">
                    <%
                        ...
                        Product product = db.getById(59);
                    %>
                    <a href="#"><i class="bi bi-cart"></i>add cart</a>
                    <a href="../../add-cart?id=<%= product.getId(59)%>">Thêm vào giỏ hàng</a>
                </div>
            </div>
