...
<div id="bill-wrapper">
    <div id="information-customer">
        ...
        <div class="form-check" style="padding: 20px">
            <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault" style="font-size: 20px;
    border: 1px solid black;">
            <label class="form-check-label" for="flexCheckDefault">
                Tôi đã đọc, hiểu và chấp nhận về quyền riêng tư cũng như điều khoan và điều kiện.
            </label>
        </div>
