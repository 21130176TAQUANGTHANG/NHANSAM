...
<div class="abc" style="padding: 20px 100px; border: 1px solid aliceblue;">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="yx1.jsp" style="color: #BF1E2E;text-decoration: none; font-size: 16px;">Yến Chưng Hồng Hoa Cúc Táo Đỏ Đường Stevia- Hũ 100ml</a></li>
        </ol>
    </nav>
</div>
...
<div id="super-item">
    ...
    <div class="img-product">
        ...
        <div class="information-product">
            <div class="information-buy">
                ...
                <h2>Yến Chưng Hồng Hoa Cúc Táo Đỏ Đường Stevia- Hũ 100ml</h2>
                ...
                <p>Giá: <b style="color: #BF1E2E; font-size: 25px; margin-left: 30px">110,000</b> </p>
                ...
                <div class="buy-item">
                    ...
                    <a href="../../add-cart?id=<%= product.getId(30)%>">Thêm vào giỏ hàng</a>
                </div>
            </div>
    ...
    <div class="information-product-item">
        ...
        <div class="congdung">
            <img src="https://ngochoangyen.com/wp-content/uploads/2023/09/yen-chung-tuoi-ngoc-hoang-yen-su-lua-chon-cua-moi-nha-1.jpg" alt="">
            <p><i class="bi bi-magic"></i><b>Yến Chưng Hồng Hoa Cúc Táo Đỏ Đường Stevia</b>Yến chưng đường Stevia phù hợp với người tiểu đường, người ăn kiêng</p>

            <p><i class="bi bi-magic"></i><b>Yến Chưng Hồng Hoa Cúc Táo Đỏ Đường Stevia</b>100% sợi yến tự nhiên, không chất phụ gia, không chất bảo quản, không chất tạo mùi</p>
            <p><i class="bi bi-magic"></i><b>Yến Chưng Hồng Hoa Cúc Táo Đỏ Đường Stevia</b> Thích hợp để bồi bổ và hồi phục cơ thể sau bệnh, dưỡng thai,
                tăng cường dinh dưỡng cho trẻ em hay người lớn tuổi và là món quà biếu tặng vô cùng ý nghĩa</p>
            <p><i class="bi bi-magic"></i><b>Yến Chưng Hồng Hoa Cúc Táo Đỏ Đường Stevia</b> Sản phẩm còn đạt chứng nhận vệ sinh An toàn thực phẩm
        ...
        <div class="congdung">
            ...
            <p><i class="bi bi-dot"></i>Nguyên liệu Yến chưng hồng hoa cúc táo đỏ đường stevia:<br>
                ...
                <i class="bi bi-check-lg"></i>Táo tàu Hàn Quốc<br>
