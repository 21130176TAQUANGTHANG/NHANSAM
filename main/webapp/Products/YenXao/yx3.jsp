...
<div id="super-item">
    ...
    <div class="img-product">
        <div class="img">
            <img src="https://samyenngochoang.com/wp-content/uploads/2020/07/1_Yen-tuoi-Ngoc-Hoang-Yen.jpg" alt=""width="1200" height="668">
        </div>
            ...
            <div class="information-buy">
                ...
                <div class="buy-item">
                    <%
                        ...
                        Product product = db.getById(27);
                    %>
                    <a href="#"><i class="bi bi-cart"></i>add cart</a>
                    <a href="../../add-cart?id=<%= product.getId(27)%>">Thêm vào giỏ hàng</a>
                </div>
            </div>
