...
<div id="super-item">
    ...
    <div class="img-product">
        <div class="img">
            <img src="https://linhchinonglam.com/wp-content/uploads/2018/12/nam-linh-linh-chi-nong-lam-thuong-hang-thai-lat-01-1.jpg" alt="">
        </div>

        <div class="information-product">
            <div class="information-buy">

                <h2>Linh Chi Nông Lâm Thượng Hạng Thái Lát(250g)</h2>
                ...
                <div class="buy-item">
                    <%
                        ...
                        Product product = db.getById(44);
                    %>
                    <a href="#"><i class="bi bi-cart"></i>add cart</a>
                    <a href="../../add-cart?id=<%= product.getId(44)%>">Thêm vào giỏ hàng</a>
                </div>
            </div>
