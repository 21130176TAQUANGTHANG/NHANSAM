...
<div id="super-item">
    ...
    <div class="img-product">
        <div class="img">
            <img src="https://linhchinonglam.com/wp-content/uploads/2018/12/LCTH-5.png" alt="">
        </div>

        <div class="information-product">
            <div class="information-buy">

                <h2>Linh Chi Nông Lâm Thượng Hạng Thái lát(500g)</h2>
                ...
                <div class="buy-item">
                    <%
                        ...
                        Product product = db.getById(43);
                    %>
                    <a href="#"><i class="bi bi-cart"></i>add cart</a>
                    <a href="../../add-cart?id=<%= product.getId(43)%>">Thêm vào giỏ hàng</a>
                </div>
            </div>
