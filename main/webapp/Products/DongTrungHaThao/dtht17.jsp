...
<div id="super-item">
    ...
    <div class="img-product">
        <div class="img">
            <img src="https://linhchinonglam.com/wp-content/uploads/2018/11/vwtywvFMOQ0eHygveoBv7BteTiERMiY35agTpBmX.jpeg" alt="">
        </div>

        <div class="information-product">
            <div class="information-buy">

                <h2>Nước Trùng Thảo Yến Sào Nông Lâm 6 lọ</h2>
                ...
                <div class="buy-item">
                    <%
                        ...
                        Product product = db.getById(64);
                    %>
                    <a href="#"><i class="bi bi-cart"></i>add cart</a>
                    <a href="../../add-cart?id=<%= product.getId(64)%>">Thêm vào giỏ hàng</a>
                </div>
            </div>
