...
<div id="super-item">
    ...
    <div class="img-product">
        <div class="img">
            <img src="https://linhchinonglam.com/wp-content/uploads/2018/11/Vien-Nang-Dong-Trung-Ha-Thao-Nong-Lam-05.jpg" alt="">
        </div>

        <div class="information-product">
            <div class="information-buy">

                <h2>Viên Nang Đông Trùng Hạ Thảo Nông Lâm (Lọ 50 viên)</h2>
                ...
                <div class="buy-item">
                    <%
                        ...
                        Product product = db.getById(61);
                    %>
                    <a href="#"><i class="bi bi-cart"></i>add cart</a>
                    <a href="../../add-cart?id=<%= product.getId(61)%>">Thêm vào giỏ hàng</a>
                </div>
            </div>
