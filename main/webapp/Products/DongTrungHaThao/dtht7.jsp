...
<div id="super-item">
    ...
    <div class="img-product">
        <div class="img">
            <img src="ttps://linhchinonglam.com/wp-content/uploads/2022/07/4.png" alt="">
        </div>

        <div class="information-product">
            <div class="information-buy">

                <h2>Đông Trùng Hạ Thảo Militaris (Nhộng Tằm) Nông Lâm (100g)</h2>
                ...
                <div class="buy-item">
                    <%
                        ...
                        Product product = db.getById(54);
                    %>
                    <a href="#"><i class="bi bi-cart"></i>add cart</a>
                    <a href="../../add-cart?id=<%= product.getId(54)%>">Thêm vào giỏ hàng</a>
                </div>
            </div>
